...
`n---`n`n## 5. Développement & Debugging (Priorité : Haute)`n`n### Chrome DevTools MCP`n*   **Source :** [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)`n*   **Utilité :** Inspection et débogage en direct du site dans le navigateur via l IA.`n*   **Applications :**`n    *   Débogage précis des erreurs JavaScript et des problèmes de chargement des scripts.`n    *   Inspection de l état des PWA et des Service Workers.`n    *   Optimisation en direct des styles CSS et de la mise en page responsive.`n`n### Puppeteer / Browser MCP`n*   **Utilité :** Tests automatisés et navigation web.`n*   **Applications :**`n    *   Vérification automatique du bon fonctionnement du site après chaque build.`n    *   Simulation de parcours clients pour tester les formulaires de commande.
